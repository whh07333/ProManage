...
abstract class BigNumber implements \Serializable, \JsonSerializable
{
     ...
     */
    private static function floatToString($float)
    {
     ...
     * @psalm-pure
     */
    protected function newBigInteger($value)
    {
     ...
     * @psalm-pure
     */
    protected function newBigDecimal($value, $scale = 0)
    {
     ...
     * @psalm-pure
     */
    protected function newBigRational($numerator, $denominator, $checkDenominator)
    {
