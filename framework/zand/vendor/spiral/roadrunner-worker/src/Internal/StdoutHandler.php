...
final class StdoutHandler
{
     ...
     */
    public static function register(int $chunkSize = self::OB_CHUNK_SIZE)
    {
     ...
     * @return void
     */
    private static function restreamHeaders()
    {
     ...
     * @return void
     */
    private static function restreamOutputBuffer($chunkSize)
    {
     ...
     * @return void
     */
    private static function restreamSymfonyDumper()
    {
