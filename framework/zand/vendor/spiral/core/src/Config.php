...
class Config implements IteratorAggregate
{
    ...
    public function __construct(
        public readonly $state = State::class,
        public readonly $resolver = Resolver::class,
        public readonly $factory = Factory::class,
        public readonly $container = Container::class,
        public readonly $binder = Binder::class,
        public readonly $invoker = Invoker::class,
        public readonly $tracer = Tracer::class,
    ) {
