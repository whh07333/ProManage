      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <?php echo html::hidden("account[$i]", $member->account);?>
          </td>
        ...
        <tr class='addedItem'>
          <td><?php echo html::select("account[$i]", $users, $deptAccount, "class='form-control user-picker' onchange='setRole(this.value, $i)'");?></td>
        ...
        <tr class='addedItem'>
          <td><?php echo html::select("account[$i]", $users, $member2Import->account, "class='form-control user-picker' onchange='setRole(this.value, $i)' data-max-list-count=" . $config->maxCount);?></td>
        ...
        <?php for($j = 0; $j < 5; $j ++):?>
        <tr class='addedItem'>
          <td><?php echo html::select("account[$i]", $users, '', "class='form-control user-picker' onchange='setRole(this.value, $i)' data-max-list-count=" . $config->maxCount);?></td>
...
<div>
  ...
  <table class='hidden'>
    <tr id='addItem' class='hidden'>
      <td><?php echo html::select("account[$i]", $users, '', "class='form-control' onchange='setRole(this.value, $i)' data-max-list-count=" . $config->maxCount);?></td>
      <td><?php echo html::input("roles[$i]", '', "class='form-control'");?></td>
      <td><?php echo html::input("days[$i]", $research->days, "class='form-control'");?></td>
      <td><?php echo html::input("hours[$i]", $config->execution->defaultWorkhours, "class='form-control'");?></td>
      <td><?php echo html::radio("limited[$i]", $lang->team->limitedList, 'no');?></td>
