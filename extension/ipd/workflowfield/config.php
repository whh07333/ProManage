...
$config->workflowfield->default->options['deleted']    = $lang->workflowfield->default->options->deleted;
...
$config->workflowfield->approval->options['reviewStatus'] = $lang->workflowfield->approval->options->reviewStatus;
$config->workflowfield->approval->options['reviewResult'] = $lang->workflowfield->approval->options->reviewResult;
