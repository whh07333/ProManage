...
$lang->durationestimation->summary           = $lang->projectCommon . "scale: <strong class='text-danger'> %s {$lang->hourCommon}</strong>; Estimated workload: <strong id='totalWorkload' class='text-danger'> %s </strong>; Total number of men: <strong id='totalStaff' class='text-danger'> %s </strong>";
