...
$lang->action->desc->submited              = '$date, Submited by <strong>$actor</strong>.' . "\n";
$lang->action->desc->submitedreview        = '$date, Submitted review by <strong>$actor</strong>.' . "\n";
...
$lang->action->desc->approvalsubmit        = '$date, Submitted review by <strong>$actor</strong>.' . "\n";
$lang->action->desc->approvalcancel        = '$date, canceled review by <strong>$actor</strong>.' . "\n";
$lang->action->desc->approvalreview        = '$date, Reviewed By <strong>$actor</strong>.' . 'Review result is <strong>$extra</strong>。' ."\n";
$lang->action->desc->approvalpass          = '$date, Approved by <strong>$actor</strong>.' . 'The result is <strong>passed</strong>.' ."\n";
$lang->action->desc->approvalreject        = '$date, Approved by <strong>$actor</strong>.' . 'The result is <strong>rejected</strong>.' ."\n";
...
$lang->action->desc->discontinued          = '$date, paused by <strong>$actor</strong>.' . "\n";
$lang->action->desc->editedcron            = '$date, edited cron by <strong>$actor</strong>.' . "\n";
$lang->action->desc->updatedversion        = '$date, Updated version by <strong>$actor</strong>.' . "\n";
...
$lang->action->label->submited                 = 'Submited';
...
$lang->action->label->addnode                  = 'Add Node';
...
$lang->action->label->approvalsubmit           = 'Submitted';
$lang->action->label->approvalcancel           = 'Canceled';
$lang->action->label->approvalreview           = 'Approvaled';
$lang->action->label->approvalpass             = 'Approvaled';
$lang->action->label->approvalreject           = 'Approvaled';
$lang->action->label->discontinued             = 'Discontinued';
$lang->action->label->editedcron               = 'Edited Cron';
$lang->action->label->updatedversion           = 'Updated version';
...
$lang->action->objectTypes['projectdeliverable'] = 'Deliverable';
$lang->action->objectTypes['reporttemplate']         = 'Report Template';
$lang->action->objectTypes['reporttemplatecategory'] = 'Category';
$lang->action->objectTypes['weekly']                 = 'Report';
$lang->action->objectTypes['reportcategory']         = 'Category';
...
$lang->action->label->reporttemplate      = 'Report Template|reporttemplate|view|templateID=%s';
$lang->action->label->weekly              = 'Report|weekly|view|reportID=%s';
...
$lang->action->dynamicAction->reviewissue['deleted']  = 'Delete Review Issue';

$lang->action->dynamicAction->story['import2storylib'] = 'Import Story Lib';
$lang->action->dynamicAction->story['approved']        = 'Approve Story';
$lang->action->dynamicAction->story['removed']         = 'Remove Story';
...
$lang->action->dynamicAction->issue['minuted']         = 'Manage Issue Lib';
...
$lang->action->dynamicAction->risk['hangup']         = 'Hang Up Risk';
$lang->action->dynamicAction->risk['tracked']        = 'Track Risk';
$lang->action->dynamicAction->risk['minuted']        = 'Manage Risk Log';
...
$lang->action->dynamicAction->opportunity['hangup']                = 'Hang Up Opportunity';
...
$lang->action->dynamicAction->auditplan['opened']   = 'Create Audit Plan';
$lang->action->dynamicAction->auditplan['edited']   = 'Edit Audit Plan';
$lang->action->dynamicAction->auditplan['deleted']  = 'Delete Audit Plan';
$lang->action->dynamicAction->auditplan['checked']  = 'Check Audit Plan';
$lang->action->dynamicAction->auditplan['assigned'] = 'Assign Audit Plan';

$lang->action->dynamicAction->nc['opened']    = 'Create Non-Conformances';
$lang->action->dynamicAction->nc['deleted']   = 'Delete Non-Conformances';
$lang->action->dynamicAction->nc['eidted']    = 'Edit Non-Conformances';
$lang->action->dynamicAction->nc['activated'] = 'Activate Non-Conformances';
...
$lang->action->dynamicAction->doc['approved']            = 'Approve';
$lang->action->dynamicAction->doc['removed']             = 'Remove';
$lang->action->dynamicAction->doc['assigned']            = 'Assigned to';

$lang->action->dynamicAction->reporttemplate['created']     = 'Create Report Template';
$lang->action->dynamicAction->reporttemplate['edited']      = 'Edit Report Template';
$lang->action->dynamicAction->reporttemplate['releaseddoc'] = 'Release Report Template';
$lang->action->dynamicAction->reporttemplate['commented']   = 'Comment Report Template';

$lang->action->dynamicAction->assetlib['opened'] = 'Create Lib';
$lang->action->dynamicAction->assetlib['edited'] = 'Edit Lib';

$lang->action->undeleteReportTemplateTip = 'The category of this report template has been deleted. Are you sure you want to restore it synchronously?';
$lang->action->undeleteReportTip         = 'The category of this report has been deleted. Are you sure you want to restore it synchronously?';
