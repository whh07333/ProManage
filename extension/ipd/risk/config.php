...
$config->risk->actions = new stdclass();
$config->risk->actions->view = array();
$config->risk->actions->view['mainActions']   = array('track', 'assignTo', 'createForObject', 'cancel', 'close', 'hangup', 'activate', 'importToLib');
$config->risk->actions->view['suffixActions'] = array('edit', 'delete');
...
$config->risk->search['params']['impact']            = array('operator' => '=', 'control' => 'select',  'values' => arrayUnion(array(''), $lang->risk->impactList));
$config->risk->search['params']['probability']       = array('operator' => '=', 'control' => 'select',  'values' => arrayUnion(array(''), $lang->risk->probabilityList));
$config->risk->search['params']['rate']              = array('operator' => '=', 'control' => 'input',  'values' => '');
$config->risk->search['params']['pri']               = array('operator' => '=', 'control' => 'select',  'values' => arrayUnion(array(''), $lang->risk->priList));
