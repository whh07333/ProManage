...
$lang->moduleOrder[256] = 'milestone';
...
$lang->resource->project->createDeliverable    = 'createDeliverable';
$lang->resource->project->viewDeliverable      = 'viewDeliverable';
$lang->resource->project->deleteDeliverable    = 'deleteDeliverable';
$lang->resource->project->deliverableChecklist = 'deliverableChecklist';
...
if(helper::hasFeature('project_cm'))
{
    ...
    $lang->resource->cm->submit       = 'submit';
    $lang->resource->cm->recall       = 'recall';
    $lang->resource->cm->browse       = 'browse';
    $lang->resource->cm->view         = 'view';
    $lang->resource->cm->diff         = 'diff';
...
{
    $lang->resource->projectchange = new stdclass();
    $lang->resource->projectchange->browse = 'browse';
    $lang->resource->projectchange->create = 'create';
    $lang->resource->projectchange->edit   = 'edit';
    $lang->resource->projectchange->delete = 'delete';
    $lang->resource->projectchange->submit = 'submit';
    $lang->resource->projectchange->recall = 'recall';
    $lang->resource->projectchange->view   = 'view';
}
...
$lang->resource->process->batchEdit    = 'batchEdit';
$lang->resource->process->batchEdit    = 'batchEdit';
...
$lang->resource->process->manageModule = 'manageModule';
...
$lang->resource->activity->batchEdit   = 'batchEdit';
...
$lang->resource->auditplan->browse      = 'browse';
$lang->resource->auditplan->view        = 'view';
$lang->resource->auditplan->create      = 'create';
$lang->resource->auditplan->edit        = 'edit';
...
$lang->resource->nc->create   = 'createPriv';
...
$lang->resource->deliverable->enable  = 'enable';
$lang->resource->deliverable->disable = 'disable';

if(!isset($lang->resource->workflowgroup)) $lang->resource->workflowgroup = new stdclass();
$lang->resource->workflowgroup->setModule = 'setModule';
...
$lang->resource->project->editApproval    = 'editApproval';
...
$lang->resource->weekly->browse         = 'browse';
$lang->resource->weekly->view           = 'view';
$lang->resource->weekly->create         = 'create';
$lang->resource->weekly->edit           = 'edit';
$lang->resource->weekly->delete         = 'delete';
$lang->resource->weekly->exportReport   = 'exportReport';
$lang->resource->weekly->manageCategroy = 'manageCategroy';
...
/* Resrerch plan. */
if(helper::hasFeature('project_researchplan'))
{
...
$lang->resource->reviewissue->active       = 'activate';
$lang->resource->reviewissue->close        = 'close';
$lang->resource->reviewissue->assignTo     = 'assignTo';
...
$lang->resource->review->admin               = 'admin';
$lang->resource->review->assess              = 'assess';
$lang->resource->review->create              = 'create';
$lang->resource->review->submit              = 'submit';
$lang->resource->review->submitIpd           = 'submitIpd';
$lang->resource->review->submitDeliverable   = 'submitDeliverable';
if(helper::hasFeature('project_cm'))     $lang->resource->review->submitBaseline      = 'submitBaseline';
if(helper::hasFeature('project_change')) $lang->resource->review->submitProjectchange = 'submitProjectchange';
$lang->resource->review->createFlow          = 'createFlow';
$lang->resource->review->edit                = 'edit';
$lang->resource->review->editFlow            = 'editFlow';
...
$lang->resource->review->deleteFlow          = 'deleteFlow';
if(helper::hasFeature('project_deliverable')) $lang->resource->review->submitDeliverable   = 'submitDeliverable';
if(helper::hasFeature('project_cm'))          $lang->resource->review->submitBaseline      = 'submitBaseline';
if(helper::hasFeature('project_change'))      $lang->resource->review->submitProjectchange = 'submitProjectchange';
...
$lang->resource->reporttemplate = new stdclass();
$lang->resource->reporttemplate->browse         = 'browse';
$lang->resource->reporttemplate->create         = 'create';
$lang->resource->reporttemplate->edit           = 'editAction';
$lang->resource->reporttemplate->view           = 'view';
$lang->resource->reporttemplate->delete         = 'deleteAction';
$lang->resource->reporttemplate->pause          = 'pauseAction';
$lang->resource->reporttemplate->cron           = 'cron';
$lang->resource->reporttemplate->addcategory    = 'addCategory';
$lang->resource->reporttemplate->editcategory   = 'editCategory';
$lang->resource->reporttemplate->deletecategory = 'deleteCategory';
...
if($config->vision == 'lite')
{
    ...
    unset($lang->resource->projectchange);
...
if(!$inUpgrade)
{
    ...
    {
        unset($lang->resource->deliverable);
        unset($lang->resource->execution->deliverable);
        unset($lang->resource->project->deliverable);
        unset($lang->resource->project->createDeliverable);
        unset($lang->resource->project->viewDeliverable);
        unset($lang->resource->project->deleteDeliverable);
        unset($lang->resource->project->deliverableChecklist);
    }
    ...
    if(!helper::hasFeature('project_gapanalysis'))
    {
        unset($lang->resource->trainplan);
        unset($lang->resource->gapanalysis);
    }
    ...
    if(!helper::hasFeature('BI'))             unset($lang->resource->reporttemplate);
    if(!helper::hasFeature('workestimation')) unset($lang->resource->budget,  $lang->resource->workestimation, $lang->resource->durationestimation);
}
