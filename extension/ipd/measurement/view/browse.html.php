...
<div id='mainContent' class='main-row'>
  <div class="main-col">
    <div class="cell<?php if($browseType == 'bysearch') echo ' show';?>" id="queryBox" data-url="<?php echo $this->createLink('search', 'buildOldForm', 'module=measurement');?>" data-module='measurement'></div>
