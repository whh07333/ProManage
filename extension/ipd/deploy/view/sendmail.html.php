 ...
 */
?>
<?php $mailTitle = $this->lang->deploy->common . ' #' . $object->id . ' ' . substr($object->begin, 0, 16) . ' ~ ' . substr($object->end, 0, 16) . ' ' . $object->name;?>
    ...
    <table cellpadding='0' cellspacing='0' width='600' style='border: none; border-collapse: collapse;'>
      <tr>
        <td style='padding: 10px; background-color: #F8FAFE; border: none; font-size: 14px; font-weight: 500; border-bottom: 1px solid #e5e5e5;'>
          <?php echo html::a($domain . helper::createLink('deploy', 'view', "objectID=$object->id"), $mailTitle, '', "style='color: #333; text-decoration: underline;'");?>
        </td>
      </tr>
    </table>
  </td>
