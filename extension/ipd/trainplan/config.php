...
$config->trainplan->actions = new stdclass();
$config->trainplan->actions->view = array();
$config->trainplan->actions->view['mainActions']   = array('finish', 'summary');
$config->trainplan->actions->view['suffixActions'] = array('edit', 'delete');
