...
$lang->admin->menuSetting['productflow']['name']   = '产品流程';
$lang->admin->menuSetting['productflow']['desc']   = '配置多种产品流程。';
$lang->admin->menuSetting['projectflow']['name']   = '项目流程';
$lang->admin->menuSetting['projectflow']['desc']   = '配置多种项目执行流程。';
$lang->admin->menuSetting['workflow']['name']      = '工作流';
$lang->admin->menuSetting['workflow']['desc']      = '配置全局通用的工作流。';
$lang->admin->menuSetting['approvalflow']['name']  = '审批流';
$lang->admin->menuSetting['approvalflow']['desc']  = '配置各类审批流程与规则。';
...
$lang->admin->menuList->workflow['subMenu']['datasource']   = array('link' => '数据源|workflowdatasource|browse|');
$lang->admin->menuList->workflow['subMenu']['workflowrule'] = array('link' => '验证规则|workflowrule|browse|');
