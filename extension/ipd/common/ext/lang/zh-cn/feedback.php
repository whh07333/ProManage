...
$lang->feedback->menu->browse   = array('link' => '反馈|feedback|admin|browseType=wait', 'alias' => 'create,batchcreate,edit,view,adminview,batchedit,browse,showimport,batchclose,totodo', 'subModule' => 'story,demand');
$lang->feedback->menu->ticket   = array('link' => '工单|ticket|browse', 'alias' => 'create,edit,view,batchedit,browse,showimport', 'subModule' => 'story,bug');
