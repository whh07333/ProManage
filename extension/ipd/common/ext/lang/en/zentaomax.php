...
$lang->closedFeatureNotice = 'Setting Notice';
...
$lang->reporttemplate->common     = 'Report Template';
$lang->projectchange->common      = 'Change';
...
$lang->my->menu->work['subMenu']->reviewissue = array('link' => 'Review Issue|my|work|mode=reviewissue', 'alias' => 'reviewissue');
...
if(helper::hasFeature('project_cm')) $lang->my->menu->contribute['subMenu']->baseline    = array('link' => 'Baseline|my|contribute|mode=baseline&type=createdBy', 'alias' => 'baseline');
...
$lang->my->menu->contribute['subMenu']->reviewissue = array('link' => 'Review Issue|my|contribute|mode=reviewissue', 'alias' => 'reviewissue');
...
$lang->scrum->menu->review = array('link' => 'Review|review|browse|project=%s', 'subModule' => 'review,reviewissue');

$lang->scrum->menu->review['subMenu'] = new stdclass();
$lang->scrum->menu->review['subMenu']->browse = array('link' => 'Review|review|browse|project=%s', 'alias' => 'report,assess,result,audit,create,edit,view');
$lang->scrum->menu->review['subMenu']->issue  = array('link' => 'Review Issue|reviewissue|issue|project=%s',  'alias' => 'create,edit,view');

$lang->scrum->menuOrder[28] = 'review';
$lang->scrum->dividerMenu   = ',execution,programplan,settings,';

unset($lang->scrum->menu->settings['subMenu']->workflow); // 企业版已加，此处要删除为了排序
$lang->scrum->menu->settings['subMenu']->approval = array('link' => "Approval|project|approval|project=%s", 'alias' => 'approval');
$lang->scrum->menu->settings['subMenu']->workflow = array('link' => "Project Workflow|project|workflowgroup|project=%s", 'alias' => 'workflowgroup');
...
if(helper::hasFeature('process')) $lang->scrum->menu->pssp   = array('link' => 'Process|pssp|browse|projectID=%s', 'subModule' => 'pssp');
...
if($config->systemMode != 'light')
{
    ...
    $lang->scrum->menu->other['dropMenu']->pssp        = array('link' => 'Process|pssp|browse|projectID=%s', 'subModule' => 'pssp', 'data-app' => 'project');
...
if(helper::hasFeature('project_issue'))       $lang->project->noMultiple->scrum->menu->other['dropMenu']->issue = array('link' => 'Issue|issue|browse|projectID=%s', 'subModule' => 'issue');
if(helper::hasFeature('project_risk'))        $lang->project->noMultiple->scrum->menu->other['dropMenu']->risk  = array('link' => 'Risk|risk|browse|projectID=%s', 'subModule' => 'risk');
if(helper::hasFeature('project_opportunity')) $lang->project->noMultiple->scrum->menu->other['dropMenu']->opportunity = array('link' => "Opportunity|opportunity|browse|projectID=%s", 'subModule' => 'opportunity');
if(helper::hasFeature('project_process'))     $lang->project->noMultiple->scrum->menu->other['dropMenu']->pssp = array('link' => 'Process|pssp|browse|projectID=%s', 'subModule' => 'pssp', 'data-app' => 'project');
if(helper::hasFeature('project_auditplan'))   $lang->project->noMultiple->scrum->menu->other['dropMenu']->auditplan = array('link' => "{$lang->qa->shortCommon}|auditplan|browse|projectID=%s&from=project", 'subModule' => 'auditplan,nc', 'data-app' => 'project', 'alias' => 'project-deliverablechecklist', 'links' => array('project|deliverableChecklist|projectID=%s', 'nc|browse|project=%s&from=project'));
if(helper::hasFeature('project_meeting'))     $lang->project->noMultiple->scrum->menu->other['dropMenu']->meeting = array('link' => 'Meeting|meeting|browse|projectID=%s', 'subModule' => 'meeting');

$lang->project->noMultiple->scrum->menu->auditplan['subMenu'] = new stdclass();
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->auditplan   = array('link' => 'Audit Plan|auditplan|browse|project=%s&from=project', 'alias' => 'create,view,batchcreate,edit,batchcheck,batchedit');
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common} Checklist|project|deliverableChecklist|projectID=%s");
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->nc          = array('link' => 'Non-Conformances|nc|browse|project=%s&from=project', 'alias' => 'create,edit,view');
...
$lang->execution->menu->other['dropMenu']->pssp        = array('link' => 'Process|pssp|browse|projectID=%s', 'subModule' => 'pssp');
$lang->execution->menu->other['dropMenu']->auditplan   = array('link' => "{$lang->qa->shortCommon}|auditplan|browse|executionID=%s&from=execution", 'subModule' => 'auditplan,nc', 'alias' => 'project-deliverablechecklist', 'links' => array('project|deliverableChecklist|projectID=%s', 'nc|browse|project=%s&from=execution'));
...
$lang->execution->menu->auditplan['subMenu']->auditplan   = array('link' => 'Audit Plan|auditplan|browse|project=%s&from=execution', 'alias' => 'create,view,batchcreate,edit,batchcheck,batchedit');
$lang->execution->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common} Checklist|project|deliverableChecklist|projectID=%s");
$lang->execution->menu->auditplan['subMenu']->nc          = array('link' => 'Non-Conformances|nc|browse|project=%s&from=execution', 'alias' => 'create,edit,view');
...
$lang->waterfall->menu->cm            = array('link' => 'Baseline|cm|browse|project=%s', 'subModule' => 'cm');
$lang->waterfall->menu->projectchange = array('link' => 'Changes|projectchange|browse|project=%s', 'alias' => 'create,edit,view', 'subModule' => 'projectchange');
...
$lang->waterfall->menu->auditplan['subMenu']->auditplan   = array('link' => 'Audit Plan|auditplan|browse|project=%s', 'alias' => 'create,batchcreate,edit,batchcheck,batchedit');
$lang->waterfall->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common} Checklist|project|deliverableChecklist|projectID=%s");
$lang->waterfall->menu->auditplan['subMenu']->nc          = array('link' => 'Non-Conformances|nc|browse|project=%s', 'alias' => 'edit,view');
