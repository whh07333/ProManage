...
if(helper::hasFeature('devops'))
{
    ...
    $lang->execution->menu->devops['subMenu']->review = '問題|repo|review|repoID=0&browseType=all&executionID=%s';
    $lang->execution->menu->devops['menuOrder'][60] = 'review';

    $lang->scrum->menu->devops['subMenu']->review = '問題|repo|review|repoID=0&browseType=all&executionID=%s';
    $lang->scrum->menu->devops['menuOrder'][60] = 'review';

    $lang->waterfall->menu->devops['subMenu']->review = '問題|repo|review|repoID=0&browseType=all&executionID=%s';
