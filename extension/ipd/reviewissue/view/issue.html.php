...
#mainMenu #currentItem > span.caret {right: 0px; top: 12px;}
  ...
  <div id="mainMenu" class="clearfix">
    <div class="btn-toolbar pull-left">
      ...
      <?php
      $featureBar = $lang->reviewissue->featureBar['issue'];
      if(in_array($project->model, array('scrum', 'agileplus'))) unset($featureBar['audit'], $featureBar['decision']);
      if(in_array($project->model, array('waterfall', 'waterfallplus'))) unset($featureBar['decision']);
      foreach($featureBar as $type => $label)
      {
