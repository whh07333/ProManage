$(function()
{
    ...
    $('#fieldTable button#submit').click(function(){ setTimeout(function(){$('#fieldTable').resize()}, 100); });
})
...
function setDefault($tr)
{
    ...
    if(control == 'input')
    {
        $defaultTD.html("<input type='text' name='default[" + key + "]' value='" + defaultValue + "' id='default" + key + "' class='form-control' autocomplete='off'>");
        return false;
    }
    if(control == 'date')
    {
