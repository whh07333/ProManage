...
$status     = data('status');
$executions = data('executionStats');
...
(
    ...
    (
        ...
        'url'   => $createLink,
        'disabled' => data('hasFrozenExecutions'),
        'hint'     => data('hasFrozenExecutions') ? sprintf($lang->execution->stageFrozenTip, $lang->programplan->create) : ''
    ))) : null,
