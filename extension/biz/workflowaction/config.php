...
$config->workflowaction->noDisableActions      = array('browse', 'requirement', 'epic', 'create', 'edit', 'view', 'delete');
$config->workflowaction->noShowActions         = array('browse', 'requirement', 'epic', 'create', 'export', 'exporttemplate', 'import', 'showimport', 'link', 'unlink', 'report', 'batchcreate', 'batchedit', 'batchassign');
$config->workflowaction->readonlyActions       = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'showimport', 'link', 'unlink', 'report', 'delete');
$config->workflowaction->noLinkageActions      = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'showimport', 'link', 'unlink', 'report', 'delete');
$config->workflowaction->noConditionActions    = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'showimport', 'report', 'create', 'batchcreate', 'createCase', 'batchCreateCase');
$config->workflowaction->noVerificationActions = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'link', 'unlink', 'report', 'delete');
$config->workflowaction->noHookActions         = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'link', 'unlink', 'report');
$config->workflowaction->noNoticeActions       = array('browse', 'requirement', 'epic', 'view',   'export', 'exporttemplate', 'import', 'link', 'unlink', 'report', 'delete');
$config->workflowaction->noJSActions           = array('requirement', 'epic', 'export', 'exporttemplate', 'import', 'unlink', 'delete');
$config->workflowaction->noCSSActions          = array('requirement', 'epic', 'export', 'exporttemplate', 'import', 'unlink', 'delete');
