    ...
    <form method='post' target='hiddenwin'>
        <table class='table table-form'>
          <tr>
            ...
            <td><?php echo html::radio('turnon', $lang->sms->turnonList, empty($smsConfig->turnon) ? 0 : $smsConfig->turnon)?></td>
            <td></td>
          </tr>
          <tr>
            <th><?php echo $lang->sms->debug?></th>
            <td><?php echo html::radio('debug', $lang->sms->turnonList, empty($smsConfig->debug) ? 0 : $smsConfig->debug)?></td>
          </tr>
          <tr>
            <th><?php echo $lang->sms->method?></th>
            <td><?php echo html::radio('method', $lang->sms->methodList, empty($smsConfig->method) ? 'get' : $smsConfig->method)?></td>
          </tr>
          <tr>
