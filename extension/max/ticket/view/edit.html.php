...
<?php js::set('customerRequired', strpos(",{$config->ticket->edit->requiredFields},", ',customer,') !== false); ?>
<?php js::set('contactRequired', strpos(",{$config->ticket->edit->requiredFields},", ',contact,') !== false); ?>
<?php
            ...
            <table class='table table-form'>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class='input-group'>
                      <?php echo html::input('startedDate', helper::isZeroDate($ticket->startedDate) ? '' : $ticket->startedDate, "class='form-control form-datetime' $disableStartedDate");?>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class='input-group'>
                      <?php echo html::input('resolvedDate', helper::isZeroDate($ticket->resolvedDate) ? '' : $ticket->resolvedDate, "class='form-control form-datetime' $disableResolvedDate");?>
                    </div>
                  </td>
                </tr>
                <tr>
