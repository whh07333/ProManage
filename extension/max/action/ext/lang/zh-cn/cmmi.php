...
$lang->action->desc->submited              = '$date, 由 <strong>$actor</strong> 提交。' . "\n";
$lang->action->desc->submitedreview        = '$date, 由 <strong>$actor</strong> 提交评审。' . "\n";
...
$lang->action->desc->approvalsubmit        = '$date, 由 <strong>$actor</strong> 发起评审。' . "\n";
$lang->action->desc->approvalcancel        = '$date, 由 <strong>$actor</strong> 撤销评审。' . "\n";
$lang->action->desc->approvalreview        = '$date, 由 <strong>$actor</strong> 审批。' . '审批结果为<strong>$extra</strong>。' ."\n";
$lang->action->desc->approvalpass          = '$date, 由 <strong>$actor</strong> 审批。' . '审批结果为<strong>通过</strong>。' ."\n";
$lang->action->desc->approvalreject        = '$date, 由 <strong>$actor</strong> 审批。' . '审批结果为<strong>拒绝</strong>。' ."\n";
...
$lang->action->desc->discontinued          = '$date, 由 <strong>$actor</strong> 停用。' . "\n";
$lang->action->desc->editedcron            = '$date, 由 <strong>$actor</strong> 修改定时生成规则。' . "\n";
$lang->action->desc->updatedversion        = '$date, 由 <strong>$actor</strong> 更新了版本。' . "\n";
...
$lang->action->label->submited                 = '提交了';
...
$lang->action->label->approvalsubmit           = '发起了';
$lang->action->label->approvalcancel           = '撤回了';
$lang->action->label->approvalreview           = '审批了';
$lang->action->label->approvalpass             = '审批了';
$lang->action->label->approvalreject           = '审批了';
$lang->action->label->discontinued             = '停用了';
$lang->action->label->editedcron               = '修改了定时规则';
$lang->action->label->updatedversion           = '更新了版本';

$lang->action->objectTypes['projecttemplate']    = '项目模板';
$lang->action->objectTypes['review']             = '评审';
$lang->action->objectTypes['waterfall']          = $lang->projectCommon . '评审';
...
$lang->action->objectTypes['auditplan']          = '活动检查';
...
$lang->action->objectTypes['projectdeliverable'] = '交付物';
$lang->action->objectTypes['reporttemplate']         = '报告模板';
$lang->action->objectTypes['reporttemplatecategory'] = '分类';
$lang->action->objectTypes['weekly']                 = '报告';
$lang->action->objectTypes['reportcategory']         = '分类';
...
$lang->action->label->reporttemplate      = '报告模板|reporttemplate|view|templateID=%s';
$lang->action->label->weekly              = '报告|weekly|view|reportID=%s';
...
$lang->action->dynamicAction->auditplan['opened']   = '创建活动检查';
$lang->action->dynamicAction->auditplan['edited']   = '编辑活动检查';
$lang->action->dynamicAction->auditplan['deleted']  = '删除活动检查';
$lang->action->dynamicAction->auditplan['checked']  = '检查活动检查';
$lang->action->dynamicAction->auditplan['assigned'] = '指派活动检查';
...
$lang->action->dynamicAction->reporttemplate['created']     = '创建报告模板';
$lang->action->dynamicAction->reporttemplate['edited']      = '编辑报告模板';
$lang->action->dynamicAction->reporttemplate['releaseddoc'] = '发布报告模板';
$lang->action->dynamicAction->reporttemplate['commented']   = '备注报告模板';

$lang->action->dynamicAction->assetlib['opened'] = '创建库';
$lang->action->dynamicAction->assetlib['edited'] = '编辑库';

$lang->action->undeleteReportTemplateTip = '该报告模板的分类已被删除，确认要同步还原吗？';
$lang->action->undeleteReportTip         = '该报告的分类已被删除，确认要同步还原吗？';
