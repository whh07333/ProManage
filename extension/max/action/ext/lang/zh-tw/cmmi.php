...
$lang->action->desc->submitedreview        = '$date, 由 <strong>$actor</strong> 提交評審。' . "\n";
...
$lang->action->desc->approvalsubmit        = '$date, 由 <strong>$actor</strong> 發起評審。' . "\n";
$lang->action->desc->approvalcancel        = '$date, 由 <strong>$actor</strong> 撤銷評審。' . "\n";
$lang->action->desc->approvalreview        = '$date, 由 <strong>$actor</strong> 審批。' . '審批結果為<strong>$extra</strong>。' ."\n";
$lang->action->desc->approvalpass          = '$date, 由 <strong>$actor</strong> 審批。' . '審批結果為<strong>通過</strong>。' ."\n";
$lang->action->desc->approvalreject        = '$date, 由 <strong>$actor</strong> 審批。' . '審批結果為<strong>拒絶</strong>。' ."\n";
...
$lang->action->desc->editedcron            = '$date, 由 <strong>$actor</strong> 修改定時生成規則。' . "\n";
...
$lang->action->label->approvalsubmit           = '發起了';
$lang->action->label->approvalcancel           = '撤回了';
$lang->action->label->approvalreview           = '審批了';
$lang->action->label->approvalpass             = '審批了';
$lang->action->label->approvalreject           = '審批了';
$lang->action->label->discontinued             = '停用了';
$lang->action->label->editedcron               = '修改了定時規則';
$lang->action->label->updatedversion           = '更新了版本';

$lang->action->objectTypes['projecttemplate']    = '項目模板';
$lang->action->objectTypes['review']             = '評審';
$lang->action->objectTypes['waterfall']          = $lang->projectCommon . '評審';
...
$lang->action->objectTypes['auditplan']          = '活動檢查';
...
$lang->action->objectTypes['reporttemplate']         = '報告模板';
$lang->action->objectTypes['reporttemplatecategory'] = '分類';
$lang->action->objectTypes['weekly']                 = '報告';
$lang->action->objectTypes['reportcategory']         = '分類';
...
$lang->action->label->reporttemplate      = '報告模板|reporttemplate|view|templateID=%s';
$lang->action->label->weekly              = '報告|weekly|view|reportID=%s';
...
$lang->action->dynamicAction->auditplan['opened']   = '創建活動檢查';
$lang->action->dynamicAction->auditplan['edited']   = '編輯活動檢查';
$lang->action->dynamicAction->auditplan['deleted']  = '刪除活動檢查';
$lang->action->dynamicAction->auditplan['checked']  = '檢查活動檢查';
$lang->action->dynamicAction->auditplan['assigned'] = '指派活動檢查';
...
$lang->action->dynamicAction->reporttemplate['created']     = '創建報告模板';
$lang->action->dynamicAction->reporttemplate['edited']      = '編輯報告模板';
$lang->action->dynamicAction->reporttemplate['releaseddoc'] = '發佈報告模板';
$lang->action->dynamicAction->reporttemplate['commented']   = '備註報告模板';

$lang->action->dynamicAction->assetlib['opened'] = '創建庫';
$lang->action->dynamicAction->assetlib['edited'] = '編輯庫';

$lang->action->undeleteReportTemplateTip = '該報告模板的分類已被刪除，確認要同步還原嗎？';
$lang->action->undeleteReportTip         = '該報告的分類已被刪除，確認要同步還原嗎？';
