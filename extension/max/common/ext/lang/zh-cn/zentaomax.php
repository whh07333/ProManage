...
$lang->projectauditplan->common   = '质量保证';
$lang->projectgapanalysis->common = '培训';
$lang->reviewcl->clcategory       = '维护检查单分类';
$lang->reporttemplate->browse     = '浏览报告模板';
$lang->reporttemplate->common     = '报告模板';
$lang->projectchange->common      = '项目变更';
...
$lang->my->menu->work['subMenu']->reviewissue = array('link' => '评审问题|my|work|mode=reviewissue', 'alias' => 'reviewissue');
$lang->my->menu->work['subMenu']->nc          = array('link' => '质量保证|my|work|mode=auditplan&type=mychecking', 'alias' => 'auditplan');
...
if(helper::hasFeature('project_cm')) $lang->my->menu->contribute['subMenu']->baseline    = array('link' => '基线|my|contribute|mode=baseline&type=createdBy', 'alias' => 'baseline');
...
$lang->my->menu->contribute['subMenu']->reviewissue = array('link' => '评审问题|my|contribute|mode=reviewissue', 'alias' => 'reviewissue');
$lang->my->menu->contribute['subMenu']->nc          = array('link' => '质量保证|my|contribute|mode=nc&type=createdByMe', 'alias' => 'nc');
...
$lang->scrum->menu->review = array('link' => '评审|review|browse|project=%s', 'subModule' => 'review,reviewissue');

$lang->scrum->menu->review['subMenu'] = new stdclass();
$lang->scrum->menu->review['subMenu']->browse = array('link' => '评审|review|browse|project=%s', 'alias' => 'report,assess,result,audit,create,edit,view');
$lang->scrum->menu->review['subMenu']->issue  = array('link' => '评审问题|reviewissue|issue|project=%s',  'alias' => 'create,edit,view');
...
$lang->scrum->menu->settings['subMenu']->approval = array('link' => "评审设置|project|approval|project=%s", 'alias' => 'approval');
$lang->scrum->menu->settings['subMenu']->workflow = array('link' => "项目流程|project|workflowgroup|project=%s", 'alias' => 'workflowgroup');
...
if(helper::hasFeature('process')) $lang->scrum->menu->pssp   = array('link' => '过程|pssp|browse|projectID=%s', 'subModule' => 'pssp');
...
if($config->systemMode != 'light')
{
    ...
    $lang->scrum->menu->other['dropMenu']->pssp        = array('link' => '过程|pssp|browse|projectID=%s', 'subModule' => 'pssp', 'data-app' => 'project');
...
if(helper::hasFeature('project_issue'))       $lang->project->noMultiple->scrum->menu->other['dropMenu']->issue = array('link' => '问题|issue|browse|projectID=%s', 'subModule' => 'issue');
if(helper::hasFeature('project_risk'))        $lang->project->noMultiple->scrum->menu->other['dropMenu']->risk  = array('link' => '风险|risk|browse|projectID=%s', 'subModule' => 'risk');
if(helper::hasFeature('project_opportunity')) $lang->project->noMultiple->scrum->menu->other['dropMenu']->opportunity = array('link' => "机会|opportunity|browse|projectID=%s", 'subModule' => 'opportunity');
if(helper::hasFeature('project_process'))     $lang->project->noMultiple->scrum->menu->other['dropMenu']->pssp = array('link' => '过程|pssp|browse|projectID=%s', 'subModule' => 'pssp', 'data-app' => 'project');
...
if(helper::hasFeature('project_meeting'))     $lang->project->noMultiple->scrum->menu->other['dropMenu']->meeting = array('link' => '会议|meeting|browse|projectID=%s', 'subModule' => 'meeting');

$lang->project->noMultiple->scrum->menu->auditplan['subMenu'] = new stdclass();
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->auditplan   = array('link' => '活动检查|auditplan|browse|projectID=%s', 'alias' => 'create,view,batchcreate,edit,batchcheck,batchedit');
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common}检查|project|deliverableChecklist|projectID=%s");
...
$lang->execution->menu->other['dropMenu']->pssp        = array('link' => '过程|pssp|browse|projectID=%s', 'subModule' => 'pssp');
...
$lang->execution->menu->auditplan['subMenu']->auditplan   = array('link' => '活动检查|auditplan|browse|projectID=%s', 'alias' => 'create,view,batchcreate,edit,batchcheck,batchedit');
$lang->execution->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common}检查|project|deliverableChecklist|projectID=%s");
...
$lang->waterfall->menu->cm            = array('link' => '基线|cm|browse|project=%s', 'subModule' => 'cm');
$lang->waterfall->menu->projectchange = array('link' => '变更|projectchange|browse|project=%s', 'alias' => 'create,edit,view', 'subModule' => 'projectchange');
...
$lang->waterfall->menu->auditplan['subMenu']->auditplan   = array('link' => '活动检查|auditplan|browse|projectID=%s', 'alias' => 'create,view,batchcreate,edit,batchcheck,batchedit');
$lang->waterfall->menu->auditplan['subMenu']->deliverable = array('link' => "{$lang->deliverable->common}检查|project|deliverableChecklist|projectID=%s");
...
$lang->waterfall->menu->review['subMenu']->browse = array('link' => '评审|review|browse|project=%s', 'alias' => 'report,assess,result,audit,create,edit,view');
$lang->waterfall->menu->review['subMenu']->issue  = array('link' => '评审问题|reviewissue|issue|project=%s',  'alias' => 'create,edit,view');
...
$lang->waterfall->menu->settings['subMenu']->approval = array('link' => "评审设置|project|approval|project=%s", 'alias' => 'approval');
