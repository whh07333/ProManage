      ...
      <table class='table table-form' id='objectTable'>
        <thead>
          <tr>
            ...
            <th class='w-110px required'><?php echo $isEn ? $lang->effort->consumed : ($lang->effort->consumed . '(' . $lang->effort->hour . ')');?></th>
            <th class='col-left required'><?php echo $isEn ? $lang->effort->left : ($lang->effort->left . '(' . $lang->effort->hour . ')');?></th>
