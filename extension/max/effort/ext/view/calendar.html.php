...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    ...
    common::printLink('effort', 'batchCreate', "date=$date", "<i class='icon icon-plus'></i> " . $lang->effort->create, '', "class='btn btn-primary' id='batchCreate' data-toggle='modal'", '', true);
    ?>
  </div>
</div>
<div class="main-row">
            ...
            $.ajax(
            {
                ...
                success: function(data)
                {
                    $.each(data, function(index, effort)
                    {
                        ...
                        effort.consumed = Number(effort.consumed).toFixed(2);
                    });
