  ...
  <div class="side-col" id="sidebar">
    ...
    <div class="cell">
      <ul class="nav nav-secondary nav-justified">
        ...
        <?php if(count($noEmptyObjects) == $showNum):?>
