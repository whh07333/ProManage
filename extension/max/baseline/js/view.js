$(document).ready(function()
{
    ...
    function updateOrders(ele, parentOrder, orders)
    {
        ...
        {
            ele = $('.bookTree > dl, .bookTree > .catalog > dl');
            root = true;
            orders = {};
        }
    ...
    $('.bookTree dl').append('<dd class="catalog catalog-empty">&nbsp;</dd>');

    $('.bookTree > dl > .catalog .catalog, .bookTree > dl > .catalog').not('.catalog-empty').droppable(
    {
        ...
        start: function()
        {
            $('.bookTree').addClass('show-empty-catalog');
        },
        drag: function(e)
        {
            if(e.target)
        ...
        {
            $('.drop-area').removeClass('drop-area');
            $('.bookTree').removeClass('show-empty-catalog');
        }
    });
