...
$lang->install->login      = '登錄禪道項目管理軟件';
$lang->install->register   = '禪道社區註冊';

$lang->install->successLabel       = "<p>您已經成功安裝禪道項目管理軟件%s。</p>";
$lang->install->successNoticeLabel = "<p>您已經成功安裝禪道項目管理軟件%s，<strong class='text-danger'>請及時刪除install.php</strong>。</p>";
