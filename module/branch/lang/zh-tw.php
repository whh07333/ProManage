...
$lang->branch->createdDate = '創建日期';
$lang->branch->closedDate  = '關閉日期';
...
$lang->branch->mergeTips         = '合併@branch@後，會將@branch@下面對應的發佈、計劃、構建、模組、需求、Bug、用例都合併到新的@branch@下。';
$lang->branch->targetBranchTips  = '您可以將其合併到已有的一個@branch@，也可以合併到主幹或者新創建一個@branch@。';
