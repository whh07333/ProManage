    ...
    <form method='post' class='form-condensed' id='jenkinsForm'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td>
            <input type='url' name='url' id='url' class='form-control' required placeholder='https://jenkins.example.com'>
          </td>
          <td></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <input type='text' name='token' id='token' class='form-control' required placeholder='Jenkins API token'>
          </td>
          <td></td>
        </tr>
        <tr>
