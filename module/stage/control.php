...
class stage extends control
{
     ...
     * @return void
     */
    public function browse($groupID = 0, $orderBy = "order_asc")
    {
     ...
     * @return void
     */
    public function create($groupID = 0)
    {
     ...
     * @return void
     */
    public function batchCreate($groupID = 0)
    {
        $flow = $this->config->edition == 'open' ? new stdClass() : $this->loadModel('workflowgroup')->getByID($groupID);
        if($_POST)
        {
     ...
     * @return void
     */
    public function setTRpoint($stageID)
    {
     ...
     * @return void
     */
    public function setDCPpoint($stageID)
    {
        $this->app->loadLang('review');
