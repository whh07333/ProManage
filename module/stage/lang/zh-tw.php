 ...
 */
/* Actions. */
$lang->stage->browse      = '瀏覽階段列表';
$lang->stage->browseAB    = '階段列表';
$lang->stage->create      = '新建階段';
$lang->stage->batchCreate = '批量新建階段';
$lang->stage->edit        = '編輯階段';
$lang->stage->delete      = '刪除階段';
$lang->stage->view        = '階段詳情';
$lang->stage->plusBrowse  = '融合瀑布階段列表';
$lang->stage->setTRpoint  = 'TR評審點配置';
$lang->stage->setDCPpoint = 'DCP評審點配置';
...
$lang->stage->TRpoint   = 'TR評審點';
$lang->stage->DCPpoint  = 'DCP評審點';
$lang->stage->TRname    = 'TR評審點名稱';
$lang->stage->DCPname   = 'DCP評審點名稱';
$lang->stage->pointFlow = '審批流';
$lang->stage->order     = '排序';
