...
$lang->projectrelease->publish          = "發佈";
$lang->projectrelease->product          = "所屬{$lang->productCommon}";
$lang->projectrelease->name             = $lang->product->system . '版本號';

$lang->projectrelease->featureBar['browse']['all']       = '全部';
$lang->projectrelease->featureBar['browse']['wait']      = '未開始';
$lang->projectrelease->featureBar['browse']['normal']    = '已發佈';
