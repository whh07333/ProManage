...
class datatableModel extends model
{
     ...
     * @return array
     */
    public function getSetting($module, $method = '', $showAll = false, $extra = '')
    {
     ...
     * @return array
     */
    public function getOldFieldList($module)
    {
        if(!isset($this->config->$module)) $this->loadModel($module);
     ...
     * @return object
     */
    public function getOldSetting($module)
    {
     ...
     * @return array
     */
    public function formatFields($module, $fieldList, $onlyshow = true)
    {
     ...
     * @return int
     */
    public static function sortOldCols($a, $b)
    {
     ...
     * @return array
     */
    public function appendWorkflowFields($module, $method)
    {
