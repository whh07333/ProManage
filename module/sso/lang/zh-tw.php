...
$lang->sso->help->addr = '介面地址的填寫，如果是PATH_INFO ：http://ZDOO網址/sys/sso-check.html，如果是GET：http://ZDOO網址/sys/index.php?m=sso&f=check';
$lang->sso->help->code = '代號必須與ZDOO後台設置的一致';
$lang->sso->help->key  = '密鑰必須與ZDOO後台設置的一致';
