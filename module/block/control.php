...
class block extends control
{
     ...
     * @return void
     */
    public function dashboard($dashboard, $projectID = 0)
    {
     ...
     * @return void
     */
    public function printBlock($blockID, $params = '')
    {
        session_write_close();
     ...
     * @return void
     */
    public function create($dashboard, $module = '', $code = '')
    {
        /* 处理表单提交事件。 */
        if($_POST)
        {
     ...
     * @return void
     */
    public function edit($blockID, $module = '', $code = '')
    {
        /* 处理表单提交事件。 */
        if($_POST)
        {
