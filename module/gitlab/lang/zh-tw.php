...
$lang->gitlab->failCreateWebhook = 'Webhook創建失敗，請在tmp/log/saas.' . date('Ymd') . '.log.php 中查看日誌';
...
$lang->gitlab->apiError[] = 'Failed to save group {:path=>["已經被使用"]}';
...
$lang->gitlab->errorLang[] = '私有分組的項目，可見性級別不能設為內部。';
$lang->gitlab->errorLang[] = '私有分組的項目，可見性級別不能設為公開。';
$lang->gitlab->errorLang[] = '密碼太短（最少8個字元）';
$lang->gitlab->errorLang[] = "只能包含字母、數字、'.'-'和'.'。不能以'-'開頭、以'.git'結尾或以'.atom'結尾。";
$lang->gitlab->errorLang[] = '分支名已存在。';
$lang->gitlab->errorLang[] = '保存失敗，群組URL路徑已經被使用。';
$lang->gitlab->errorLang[] = '保存失敗，群組URL路徑已經被使用。';
$lang->gitlab->errorLang[] = '當前用戶綁定GitLab賬號權限不足。';
$lang->gitlab->errorLang[] = '格式錯誤';
$lang->gitlab->errorLang[] = 'admin是保留名';
$lang->gitlab->errorLang[] = 'GitLab項目已存在';
$lang->gitlab->errorLang[] = '當前GitLab項目內沒有可用的流水綫，請先前往GitLab配置。';
$lang->gitlab->errorLang[] = '頭像大小不能超過200KB';
$lang->gitlab->errorLang[] = '引用不存在';
$lang->gitlab->errorLang[] = '頭像格式不正確';
$lang->gitlab->errorLang[] = '檔案格式不支持，請嘗試以下格式：image/png,image/jpeg,image/gif,image/bmp,image/tiff,image/vnd.microsoft.icon';
$lang->gitlab->errorLang[] = '不能使用常用的數字或字母組合';
$lang->gitlab->errorLang[] = '必須大於等於0';
$lang->gitlab->errorLang[] = '伺服器返回錯誤：500';
...
$lang->gitlab->user->projectsLimit  = "項目限制";
