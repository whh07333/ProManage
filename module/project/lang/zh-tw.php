...
$lang->project->testreport          = '測試報告列表';
...
$lang->project->coverExecutionPriv  = "執行權限控制";
...
$lang->project->milestoneReport    = '里程碑報告';
...
$lang->project->sortAuthList['extend'] = '繼承';
$lang->project->sortAuthList['reset']  = '重新定義';
...
$lang->project->moreSelects['browse']['more']['suspended'] = '已掛起';
$lang->project->moreSelects['browse']['more']['delayed']   = '已延期';
$lang->project->moreSelects['browse']['more']['closed']    = '已關閉';
...
$lang->project->coverExecutionPrivList[1] = '開啟 (開啟後，您可以在” 項目自定義權限“ 中對執行下功能（如任務、燃盡圖、測試等）進行權限管控，此操作不可逆。)';
$lang->project->coverExecutionPrivList[0] = '關閉';
