...
$lang->job->trigger       = '觸發器';
$lang->job->autoRun       = '是否觸發';
$lang->job->addTrigger    = '添加觸發方式';
...
$lang->job->repoExists     = '此代碼庫已關聯流水綫『%s』';
...
$lang->job->triggerRepeat  = '觸發方式不能重複';
