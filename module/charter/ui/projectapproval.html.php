<?php
/**
 * The project approval file of charter module of ZenTaoPMS.
 *
...
$fields = defineFieldList('charter.projectApproval');

$fields->field('appliedBy')
    ->control('picker', array('required' => true))
    ->width('1/3')
    ->items($users)
    ->value($charter->appliedBy);
...
formPanel
(
    set::title($lang->charter->projectApproval),
    set::fields($fields),
