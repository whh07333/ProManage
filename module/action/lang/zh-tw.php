...
$lang->action->objectTypes['prompt']           = '禪道智能體';
$lang->action->objectTypes['miniprogram']      = '通用智能體';
...
$lang->action->objectTypes['deliverable']      = '交付物類型';
$lang->action->objectTypes['cm']               = '基線';
$lang->action->objectTypes['baseline']         = '基線';
$lang->action->objectTypes['projectchange']    = '項目變更';
...
$lang->action->label->prompt       = '禪道智能體|ai|promptview|id=%s';
$lang->action->label->miniprogram  = '通用智能體|aiapp|browseminiprogram|id=%s';
$lang->action->label->holiday      = '節假日|holiday|browse|';
$lang->action->label->deliverable  = '交付物類型|deliverable|view|id=%s';
