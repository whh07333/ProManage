...
class weeklyModel extends model
{
     ...
     * @return int|bool
     */
    public function addBuiltinScope()
    {
     ...
     * @return int
     */
    public function addBuiltinCategory($scopeID)
    {
        /* Set category data. */
     ...
     * @return bool
     */
    public function addBuiltinTemplate($libID, $moduleID, $blockIdList)
    {
        $now         = helper::now();
     ...
     * @return string
     */
    public function getBuildinRawContent($blockIdList)
    {
