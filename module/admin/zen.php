...
class adminZen extends admin
{
     ...
     * @return bool
     */
    protected function syncExtensions($type = 'plugin', $limit = 5)
    {
     ...
     * @return bool
     */
    protected function syncPublicClasses($limit = 3)
    {
     ...
     * @return bool
     */
    protected function syncDynamics($limit = 2)
    {
     ...
     * @return string
     */
    protected function sendCodeByAPI($type)
    {
     ...
     * @return string
     */
    protected function certifyByAPI($type)
    {
        $apiConfig = $this->admin->getApiConfig();
        $module    = $type == 'mobile' ? 'sms' : 'mail';
     ...
     * @return string
     */
    protected function setCompanyByAPI()
    {
        $apiConfig = $this->admin->getApiConfig();
     ...
     * @return object
     */
    protected function getZentaoData()
    {
        $data = new stdclass();
        $data->hasData  = true;
        $data->dynamics = array();
