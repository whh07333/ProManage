...
$lang->misc->copyright   = "&copy; 2009 - " . date('Y') . " <a href='https://www.chandao.com' target='_blank'>禪道軟件（青島）有限公司</a> 電話：4006-8899-23 Email：<a href='mailto:co@zentao.net'>co@zentao.net</a>  QQ：1492153927";
...
/* Release Detail. */
$lang->misc->feature->all['22.1'][]        = array('title' => '.兼容開源版。.兼容旗艦版。', 'desc' => '');
$lang->misc->feature->all['22.1'][]        = array('title' => '.兼容開源版。.兼容旗艦版。', 'desc' => '');
$lang->misc->feature->all['22.0'][]        = array('title' => '新增了空間功能；功能開關新增部分功能；jira增加介面導入的方式；二級菜單根據屏幕大小自適應展開收起；檢索標籤根據屏幕大小自適應收起。功能開關和jira遷移優化。一些功能重構。基線和變更的審批流優化。一些功能重構。', 'desc' => '');
$lang->misc->feature->all['21.7.9'][]      = array('title' => '修復Bug修復Bug修復Bug修復Bug', 'desc' => '');
$lang->misc->feature->all['21.7.8'][]      = array('title' => 'API 2.0AI知識庫兼容企業版兼容旗艦版。', 'desc' => '');
$lang->misc->feature->all['21.7.7'][]      = array('title' => 'API2.0新版一鍵安裝包第三方類庫更新瀚高資料庫適配。.兼容旗艦版。', 'desc' => '');
$lang->misc->feature->all['21.7.6'][]      = array('title' => '..報告模板和項目報告功能。.兼容旗艦版。', 'desc' => '');
