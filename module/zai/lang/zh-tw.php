...
$lang->zai->settingTips              = '請安裝<a class="btn btn-link text-primary px-1" style="text-decoration: none;" href="%s" target="_blank">ZAI服務</a>獲取密鑰。';

$lang->zai->zentaoVectorization       = '禪道數據向量化';
$lang->zai->vectorized                = '數據向量化';
$lang->zai->vectorizedIntro           = '數據向量化會將禪道系統內產生的數據進行向量化，以便于在 AI 對話中進行引用，讓 AI 可以更準確地回答問題。';
$lang->zai->vectorizedUnavailableHint = '請先配置 ZAI 應用，並確保 ZAI 服務可用。';
