...
$lang->dataview->duplicateField = '存在重複的欄位名： %s。建議您：（1）修改 * 查詢為具體的欄位。（2）使用 as 為欄位設置別名。';
$lang->dataview->errorField     = '當前欄位<strong>%s</strong>存在非法字元,[as] 別名僅支持中英文、數字及下劃線的組合。';
$lang->dataview->queryFilterTip = '查詢篩選器是通過在 SQL 中插入變數實現動態查詢的篩選方式，第三步配置的結果篩選器是對SQL查詢結果進行進一步篩選。';
$lang->dataview->consumed       = '消耗工時';

$lang->dataview->varFilter = new stdclass();
$lang->dataview->varFilter->varCode      = '代號';
$lang->dataview->varFilter->varLabel     = '篩選器名稱';
$lang->dataview->varFilter->default      = '預設值';
$lang->dataview->varFilter->relatedField = '關聯欄位';
$lang->dataview->varFilter->requestType  = '篩選器類型';

$lang->dataview->varFilter->noticeVarName     = '名稱不能為空';
...
$lang->dataview->varFilter->requestTypeList['multipleselect'] = '多選下拉';

$lang->dataview->varFilter->selectList['product']             = $lang->productCommon . '列表';
$lang->dataview->varFilter->selectList['product.status']      = '產品狀態';
$lang->dataview->varFilter->selectList['product.type']        = '產品類型';
$lang->dataview->varFilter->selectList['productplan.status']  = '產品計劃狀態';
$lang->dataview->varFilter->selectList['project']             = '項目列表';
$lang->dataview->varFilter->selectList['project.status']      = '項目狀態';
$lang->dataview->varFilter->selectList['project.projectType'] = '項目類型';
$lang->dataview->varFilter->selectList['project.model']       = '項目管理方式';
$lang->dataview->varFilter->selectList['execution']           = $lang->executionCommon . '列表';
$lang->dataview->varFilter->selectList['execution.status']    = '執行狀態';
$lang->dataview->varFilter->selectList['execution.type']      = '執行類型';
...
if($this->config->edition != 'open') $lang->dataview->objects['feedback'] = '反饋';

$lang->dataview->tables = array();
$lang->dataview->tables['build']       = array('name' => '構建數據', 'desc' => '包括構建名稱、所屬產品、所屬項目、所屬執行、創建人等');
...
$lang->dataview->tables['release']     = array('name' => '產品發佈數據', 'desc' => '包括發佈名稱、所屬產品、所屬項目、相關構建、創建人等');
...
$lang->dataview->tables['bugbuild']    = array('name' => '構建Bug數據', 'desc' => '構建的Bug嚴重程度、優先順序、解決人、所屬項目、所屬產品等');
...
$lang->dataview->groupList['feedback']  = '反饋';
