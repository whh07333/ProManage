...
class reportTao extends reportModel
{
     ...
     * @return array
     */
    protected function getAnnualProductStat($accounts, $year)
    {
     ...
     * @return array
     */
    protected function getAnnualExecutionStat($accounts, $year)
    {
     ...
     * @return array
     */
    protected function buildAnnualCaseStat($accounts, $year, $actionStat, $resultStat)
    {
     ...
     * @return array
     */
    protected function getOutputData($accounts, $year)
    {
        /* Get output actions. */
