...
class ManagerFactory implements ManagerFactoryInterface
{
     ...
     */
    public function __construct($entityFactory, $helperFactory)
    {
     ...
     */
    public function createWorkbookManager($optionsManager)
    {
     ...
     */
    private function createWorksheetManager($styleManager, $styleMerger)
    {
     ...
     * @return StyleManager
     */
    private function createStyleManager($optionsManager)
    {
     ...
     */
    private function createStyleRegistry($optionsManager)
    {
