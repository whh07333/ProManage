...
class SheetManager
{
     ...
     */
    public function __construct($stringHelper)
    {
     ...
     * @return void
     */
    public function throwIfNameIsInvalid($name, $sheet)
    {
        if (!\is_string($name)) {
     ...
     */
    private function isNameUnique($name, $sheet)
    {
     ...
     * @return void
     */
    public function markSheetNameAsUsed($sheet)
    {
