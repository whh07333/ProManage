...
class StyleMerger
{
     ...
     * @return void
     */
    private function mergeFontStyles($styleToUpdate, $style, $baseStyle)
    {
     ...
     * @return void
     */
    private function mergeOtherFontProperties($styleToUpdate, $style, $baseStyle)
    {
     ...
     * @return void
     */
    private function mergeCellProperties($styleToUpdate, $style, $baseStyle)
    {
