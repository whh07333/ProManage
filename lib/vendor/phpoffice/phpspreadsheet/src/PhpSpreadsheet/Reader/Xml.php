...
class Xml extends BaseReader
{
     ...
     */
    private function parseStyles($xml, $namespaces)
    {
        if (!isset($xml->Styles)) {
            return;
        }
     ...
     */
    private function parseStyleAlignment($styleID, $styleAttributes)
    {
     ...
     * @param array $namespaces
     */
    private function parseStyleBorders($styleID, $styleData, $namespaces)
    {
     ...
     * @param SimpleXMLElement $styleAttributes
     */
    private function parseStyleFont($styleID, $styleAttributes)
    {
        $underlineStyles = [
            Font::UNDERLINE_NONE,
     ...
     * @param SimpleXMLElement $styleAttributes
     */
    private function parseStyleInterior($styleID, $styleAttributes)
    {
        foreach ($styleAttributes as $styleAttributeKey => $styleAttributeValue) {
            switch ($styleAttributeKey) {
                case 'Color':
     ...
     * @param SimpleXMLElement $styleAttributes
     */
    private function parseStyleNumberFormat($styleID, $styleAttributes)
    {
        $fromFormats = ['\-', '\ '];
        $toFormats = ['-', ' '];
