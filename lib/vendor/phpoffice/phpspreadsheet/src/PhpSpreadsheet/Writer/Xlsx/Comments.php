...
class Comments extends WriterPart
{
     ...
     */
    public function writeComments($pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeComment($objWriter, $pCellReference, $pComment, $pAuthors)
    {
        // comment
     ...
     * @return string XML Output
     */
    public function writeVMLComments($pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @param Comment $pComment Comment
     */
    private function writeVMLComment($objWriter, $pCellReference, $pComment)
    {
        // Metadata
