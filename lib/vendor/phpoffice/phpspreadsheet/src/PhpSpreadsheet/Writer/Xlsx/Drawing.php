...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings($pWorksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    public function writeChart($objWriter, $pChart, $pRelationId = -1)
    {
     ...
     * @throws WriterException
     */
    public function writeDrawing($objWriter, $pDrawing, $pRelationId = -1, $hlinkClickId = null)
    {
        if ($pRelationId >= 0) {
            // xdr:oneCellAnchor
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages($pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     */
    private function writeVMLHeaderFooterImage($objWriter, $pReference, $pImage)
    {
        // Calculate object id
     ...
     */
    public function allDrawings($spreadsheet)
    {
        // Get an array of all drawings
        $aDrawings = [];
     ...
     * @param null|int $hlinkClickId
     */
    private function writeHyperLinkDrawing($objWriter, $hlinkClickId)
    {
