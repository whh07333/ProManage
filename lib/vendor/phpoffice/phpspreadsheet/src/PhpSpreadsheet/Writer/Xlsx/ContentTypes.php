...
class ContentTypes extends WriterPart
{
     ...
     */
    public function writeContentTypes($spreadsheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws WriterException
     */
    private function writeDefaultContentType($objWriter, $pPartname, $pContentType)
    {
     ...
     * @throws WriterException
     */
    private function writeOverrideContentType($objWriter, $pPartname, $pContentType)
    {
        if ($pPartname != '' && $pContentType != '') {
            // Write content type
