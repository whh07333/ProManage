...
class Style extends WriterPart
{
     ...
     */
    public function writeStyles($spreadsheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    private function writeFill($objWriter, $pFill)
    {
     ...
     * @param Fill $pFill Fill style
     */
    private function writeGradientFill($objWriter, $pFill)
    {
        // fill
     ...
     * @param Fill $pFill Fill style
     */
    private function writePatternFill($objWriter, $pFill)
    {
        // fill
        $objWriter->startElement('fill');
     ...
     */
    private function writeFont($objWriter, $pFont)
    {
        // font
     ...
     */
    private function writeBorder($objWriter, $pBorders)
    {
        // Write border
     ...
     * @throws \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeCellStyleXf($objWriter, $pStyle, $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \PhpOffice\PhpSpreadsheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf($objWriter, $pStyle)
    {
        // dxf
     ...
     */
    private function writeBorderPr($objWriter, $pName, $pBorder)
    {
        // Write BorderPr
     ...
     */
    private function writeNumFmt($objWriter, $pNumberFormat, $pId = 0)
    {
     ...
     */
    public function allStyles($spreadsheet)
    {
     ...
     */
    public function allConditionalStyles($spreadsheet)
    {
        // Get an array of all styles
        $aStyles = [];
     ...
     */
    public function allFills($spreadsheet)
    {
     ...
     */
    public function allFonts($spreadsheet)
    {
     ...
     */
    public function allBorders($spreadsheet)
    {
     ...
     */
    public function allNumberFormats($spreadsheet)
    {
