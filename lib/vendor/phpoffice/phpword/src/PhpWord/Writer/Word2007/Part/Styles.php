...
class Styles extends AbstractPart
{
     ...
     */
    private function writeDefaultStyles($xmlWriter, $styles)
    {
     ...
     */
    private function writeFontStyle($xmlWriter, $styleName, $style)
    {
     ...
     */
    private function writeParagraphStyle($xmlWriter, $styleName, $style)
    {
        $xmlWriter->startElement('w:style');
        $xmlWriter->writeAttribute('w:type', 'paragraph');
     ...
     */
    private function writeTableStyle($xmlWriter, $styleName, $style)
    {
        $xmlWriter->startElement('w:style');
