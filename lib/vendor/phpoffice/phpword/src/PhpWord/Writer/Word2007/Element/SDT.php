...
class SDT extends Text
{
     ...
     */
    private function writePlainText($xmlWriter)
    {
     ...
     */
    private function writeComboBox($xmlWriter, $element)
    {
        $type = $element->getType();
     ...
     * @param \PhpOffice\PhpWord\Element\SDT $element
     */
    private function writeDropDownList($xmlWriter, $element)
    {
     ...
     * @param \PhpOffice\PhpWord\Element\SDT $element
     */
    private function writeDate($xmlWriter, $element)
    {
        $type = $element->getType();
