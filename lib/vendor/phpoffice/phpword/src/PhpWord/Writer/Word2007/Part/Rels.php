...
class Rels extends AbstractPart
{
     ...
     * @param int $relId
     */
    protected function writeRels($xmlWriter, $xmlRels = array(), $mediaRels = array(), $relId = 1)
    {
     ...
     */
    private function writeMediaRel($xmlWriter, $relId, $mediaRel)
    {
     ...
     */
    private function writeRel($xmlWriter, $relId, $type, $target, $targetMode = '')
    {
        if ($type != '' && $target != '') {
