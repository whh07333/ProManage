...
class TOC extends AbstractElement
{
     ...
     */
    private function writeTitle($xmlWriter, $element, $title, $writeFieldMark)
    {
     ...
     * @param int $indent
     */
    private function writeStyle($xmlWriter, $element, $indent)
    {
        $tocStyle = $element->getStyleTOC();
        $fontStyle = $element->getStyleFont();
        $isObject = ($fontStyle instanceof Font) ? true : false;
     ...
     * @param \PhpOffice\PhpWord\Element\TOC $element
     */
    private function writeFieldMark($xmlWriter, $element)
    {
