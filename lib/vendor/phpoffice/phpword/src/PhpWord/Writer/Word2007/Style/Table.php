...
class Table extends AbstractStyle
{
     ...
     */
    private function writeStyle($xmlWriter, $style)
    {
        // w:tblPr
        $xmlWriter->startElement('w:tblPr');
     ...
     */
    private function writeLayout($xmlWriter, $layout)
    {
     ...
     * @param \PhpOffice\PhpWord\Style\Table $style
     */
    private function writeMargin($xmlWriter, $style)
    {
        if ($style->hasMargin()) {
     ...
     * @param \PhpOffice\PhpWord\Style\Table $style
     */
    private function writeBorder($xmlWriter, $style)
    {
        if ($style->hasBorder()) {
     ...
     */
    private function writeTblWidth($xmlWriter, $elementName, $unit, $width = null)
    {
        if (null === $width) {
            return;
        }
     ...
     * @param \PhpOffice\PhpWord\Style\Table $style
     */
    private function writeFirstRow($xmlWriter, $style)
    {
     ...
     * @param \PhpOffice\PhpWord\Style\Table $style
     */
    private function writeShading($xmlWriter, $style)
    {
     ...
     */
    private function writeIndent($xmlWriter, $style)
    {
