...
class Content extends AbstractPart
{
     ...
     */
    private function writeAutoStyles($xmlWriter)
    {
     ...
     * @param \PhpOffice\PhpWord\Shared\XMLWriter $xmlWriter
     */
    private function writeTextStyles($xmlWriter)
    {
     ...
     */
    private function getAutoStyles($phpWord)
    {
        $sections = $phpWord->getSections();
        $paragraphStyleCount = 0;
        $fontStyleCount = 0;
     ...
     */
    private function collectTrackedChanges($container, &$trackedChanges = array())
    {
        $elements = $container->getElements();
        foreach ($elements as $element) {
