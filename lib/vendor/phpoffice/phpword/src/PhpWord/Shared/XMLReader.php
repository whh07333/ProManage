...
class XMLReader
{
     ...
     * @return \DOMNodeList
     */
    public function getElements($path, $contextNode = null)
    {
        if ($this->dom === null) {
            return array();
        }
     ...
     */
    public function getElement($path, $contextNode = null)
    {
     ...
     * @return string|null
     */
    public function getAttribute($attribute, $contextNode = null, $path = null)
    {
        $return = null;
        if ($path !== null) {
            $elements = $this->getElements($path, $contextNode);
     ...
     * @return string|null
     */
    public function getValue($path, $contextNode = null)
    {
        $elements = $this->getElements($path, $contextNode);
        if ($elements->length > 0) {
     ...
     * @return int
     */
    public function countElements($path, $contextNode = null)
    {
        $elements = $this->getElements($path, $contextNode);
     ...
     * @return bool
     */
    public function elementExists($path, $contextNode = null)
    {
