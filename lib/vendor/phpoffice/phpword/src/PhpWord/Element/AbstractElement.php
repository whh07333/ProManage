...
abstract class AbstractElement
{
     ...
     */
    public function setPhpWord($phpWord = null)
    {
     ...
     * @param Comment $value
     */
    public function setCommentRangeStart($value)
    {
     ...
     * @param Comment $value
     */
    public function setCommentRangeEnd($value)
    {
        if ($this instanceof Comment) {
            throw new \InvalidArgumentException('Cannot set a Comment on a Comment');
        }
     ...
     */
    public function setTrackChange($trackChange)
    {
