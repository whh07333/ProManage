...
class Document extends AbstractPart
{
     ...
     * @return array
     */
    private function readSectionStyle($xmlReader, $domNode)
    {
        $styleDefs = array(
     ...
     */
    private function readWPNode($xmlReader, $node, &$section)
    {
        // Page break
     ...
     * @param \PhpOffice\PhpWord\Element\Section &$section
     */
    private function readWSectPrNode($xmlReader, $node, &$section)
    {
