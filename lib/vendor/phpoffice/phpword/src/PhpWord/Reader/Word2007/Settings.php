...
class Settings extends AbstractPart
{
     ...
     */
    protected function setThemeFontLang($xmlReader, $phpWord, $node)
    {
     ...
     * @param \DOMElement $node
     */
    protected function setDocumentProtection($xmlReader, $phpWord, $node)
    {
     ...
     * @param \DOMElement $node
     */
    protected function setProofState($xmlReader, $phpWord, $node)
    {
     ...
     * @param \DOMElement $node
     */
    protected function setZoom($xmlReader, $phpWord, $node)
    {
     ...
     * @param \DOMElement $node
     */
    protected function setRevisionView($xmlReader, $phpWord, $node)
    {
     ...
     * @param \DOMElement $node
     */
    protected function setConsecutiveHyphenLimit($xmlReader, $phpWord, $node)
    {
        $value = $xmlReader->getAttribute('w:val', $node);
     ...
     * @param \DOMElement $node
     */
    protected function setHyphenationZone($xmlReader, $phpWord, $node)
    {
        $value = $xmlReader->getAttribute('w:val', $node);
