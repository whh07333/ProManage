...
class thinkAnsoff extends thinkModel
{
    ...
    protected function buildAreaCard($order)
    {
    ...
    protected function buildRow($key, $showTitle = false)
    {
        global $app, $lang;
    ...
    {
        $mode  = $this->prop('mode');
        $style = $mode == 'preview' ? setStyle(array('min-height' => '254px')) : setStyle(array('min-height' => '254px', 'min-width' => '2200px'));
