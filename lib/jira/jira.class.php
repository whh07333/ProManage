...
class jira
{
     ...
     * @return void
     */
    public function __construct($jiraDomain, $jiraAccount, $jiraToken)
    {
     ...
     * @return array
     */
    public function getProjects($startAt = 0)
    {
     ...
     * @return array
     */
    public function getBuilds($projectID = 0, $startAt = 0, $maxResults = 50)
    {
     ...
     * @return array
     */
    public function getIssueLinks($startAt = 0, $maxResults = 50)
    {
