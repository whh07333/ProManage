...
$config->logonMethods[] = 'devws.assignto';
$config->logonMethods[] = 'devws.create';
...
define('TABLE_CHATROOM',      '`' . $config->db->prefix . 'chatroom`');
define('TABLE_CHATMESSAGE',   '`' . $config->db->prefix . 'chatmessage`');
define('TABLE_CHATROOMMEMBER','`' . $config->db->prefix . 'chatroommember`');
define('TABLE_CHATMENTION',   '`' . $config->db->prefix . 'chatmention`');
